...
const blockChainsData = [
  ...testNetwork,
  {
    ...
    receiver: '0x35597808eC4E434F17c7007882fE7768009f4deF',
  ...
  },
  {
    ...
    networkType: 'pol',
    token: '0xD566886eB93500e2BA464bd48c8D5A2556569253',
    receiver: '0xad3B70Fa8581D2db606533f8aB2E38635bE4e873',
...
const config = {
  ...
  ABI: {
    ...
    receiver: [{"inputs":[{"internalType":"address","name":"_token","type":"address"}],"stateMutability":"nonpayable","type":"constructor"},{"inputs":[{"internalType":"uint256","name":"amount","type":"uint256"}],"name":"burn","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"token","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"}]
  }
}
